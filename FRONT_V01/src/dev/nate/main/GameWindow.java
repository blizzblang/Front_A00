...
public class GameWindow {
	...
	private ArrayList<Integer> keyUps;
	private ArrayList<Integer> pushKeys;
	...
	public void tick() { // Pre loop updates
	...
	public void tock() { // Post loop updates
	...
	public dev.nate.main.ProjectionMatrix getPm() {
		return ProMatrix;
	}
	
	public boolean getKeyDown(int a) {
		boolean ret = false;
	...
	public boolean getKeyUp(int a) {
		if(keyUps.contains(a) && !getKeyDown(a)) {
